...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-zinc-800 bg-zinc-900/50 font-medium [&_tr]:last-child:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-zinc-800/60 transition-colors hover:bg-zinc-900/30 data-[state=selected]:bg-zinc-800/50",
      className
    )}
    {...props}
  />
